...
console.log("Direct environment variables check:");
console.log(`- OPENWEATHERMAP_API_KEY exists: ${!!process.env.OPENWEATHERMAP_API_KEY}`);
console.log(`- COINCAP_API_KEY exists: ${!!process.env.COINCAP_API_KEY}`);
...
// Add this at the end of the file to make it compatible with Vercel serverless functions
export default app;
